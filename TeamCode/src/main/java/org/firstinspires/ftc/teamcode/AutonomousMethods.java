...
public class AutonomousMethods extends LinearOpMode {
    ...
    public void strafeLeftInches(double inches) {
        drive.followTrajectory(drive.trajectoryBuilder(drive.getPoseEstimate()).strafeLeft(inches).build());
    }

    public void strafeRightInches(double inches) {
        drive.followTrajectory(drive.trajectoryBuilder(drive.getPoseEstimate()).strafeRight(inches).build());
    }
